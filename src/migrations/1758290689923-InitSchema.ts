...
export class InitSchema1758290689923 implements MigrationInterface {
    name = 'InitSchema1758290689923'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`evaluacion\` (\`id\` int NOT NULL AUTO_INCREMENT, \`materiaId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`institucion_modulo\` (\`id\` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`evaluacion_alumno\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nota\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
