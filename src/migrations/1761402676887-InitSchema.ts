...
export class InitSchema1761402676887 implements MigrationInterface {
    name = 'InitSchema1761402676887'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`factura\` ADD CONSTRAINT \`FK_3c78680669c53f6ef88a5f66389\` FOREIGN KEY (\`proyectoId\`) REFERENCES \`proyecto\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`factura\` DROP FOREIGN KEY \`FK_3c78680669c53f6ef88a5f66389\``);
